...
class GeoCleaner(BaseSanio):
    def __init__(self, *args, **kwargs):
        super(GeoCleaner, self).__init__(*args, **kwargs)

    @classmethod
    def us_state_for_abbr(cls, s):
        """
        >>> GeoCleaner.us_state_for_abbr('TX')
        'Texas'

        >>> GeoCleaner.us_state_for_abbr('MS')
        'Massachusetts'
        """
        try:
            r = STATE_MAP[s]
    ...
    @classmethod
    def us_city_state_for_city(cls, s):
        """
        >>> GeoCleaner.us_city_state_for_city('Austin')
        'Austin, TX'
